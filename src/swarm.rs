//! Use `libp2p` to enable handshake-ready connections to substrate-based networks.
...
pub struct Padawan<T: NetworkBehaviour> {
...
impl<T: NetworkBehaviour> Padawan<T> {
...
pub async fn handshake(
    padawan: Padawan<dummy::Behaviour>,
